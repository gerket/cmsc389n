		...
		/* Number of rows found */
			...
			if ($num_rows === 0) {
				...
				for ($row_index = 0; $row_index < $num_rows; $row_index++) {
					...
					if($pic!==NULL)
						$body.="<tr><td rowspan=2><img alt='User Image' height=80px  onclick='window.location.href=\"userProfile.php\";' src=\"data:image/jpeg;base64,$realPic\"/></td>";
                    $body.= "<td>Welcome, <a href='userProfile.php'>$student</a>!</td></tr><tr><td align='center'><input type='button' value='Log out' onclick='window.location.href=\"login.php\";' /></td></tr>";
